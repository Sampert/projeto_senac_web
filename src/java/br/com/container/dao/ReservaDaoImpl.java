...
public class ReservaDaoImpl extends BaseDaoImpl<Reserva, Long> implements ReservaDao {
    ...
    public static void main(String[] args) {
        ...
        List todas = daoImpl.pesquisarTotalMesSala(session);
        System.out.println(todas);
        session.close();
    }

    @Override
    public List<GraficoReservaPorMesSala> pesquisarTotalMesSala(Session session) throws HibernateException {
        Object[] item;
        GraficoReservaPorMesSala grp;
        List<GraficoReservaPorMesSala> todosGrps = new ArrayList<>();
        ...
        for (Object resultado : resultados) {
            ...
            grp = new GraficoReservaPorMesSala((int)item[0], (long)item[1]);
            todosGrps.add(grp);
        }
        return todosGrps;
    }
